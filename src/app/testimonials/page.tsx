...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: settings.testimonialsTitle || 'What Clients Say? — Insights Mafia',
    description: settings.testimonialsDescription || 'Real feedback from the brands Insights Mafia has run campaigns, shoots and builds for.',
  };
}
